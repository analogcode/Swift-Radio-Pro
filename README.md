...
Myself and the AudioKit team have extensive recent experience building iOS / Apple Platform apps for both independent clients and high-profile clients. Additionally, we've built advanced versions of this open-source radio player (such as this one):
